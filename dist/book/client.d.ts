...
export declare function add_route_definition<A extends schema.AtomName, R extends schema.RouteName<A>>(atom_name: A, route_name: R, route_definition: Book.Definition.Dock.Routes.Route): Book.Definition.Dock.Routes;
