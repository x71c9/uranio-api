...
declare type ExtractParamFrom<URI extends string> = URI extends `/:${infer Param1}/:${infer Param2}/:${infer Param3}/:${infer Param4}` | `/${infer _Prefix}/:${infer Param1}/:${infer Param2}/:${infer Param3}/:${infer Param4}` ? Param1 | Param2 | Param3 | Param4 : URI extends `/:${infer Param1}/:${infer Param2}/:${infer Param3}` | `/${infer _Prefix}/:${infer Param1}/:${infer Param2}/:${infer Param3}` ? Param1 | Param2 | Param3 : URI extends `/:${infer Param1}/:${infer Param2}` | `/${infer _Prefix}/:${infer Param1}/:${infer Param2}` ? Param1 | Param2 : URI extends `/:${infer Param}` | `/${infer _Prefix}/:${infer Param}` | `/${infer __Prefix}/${infer _Prefix}/:${infer Param}` ? Param : never;
