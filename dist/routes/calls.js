...
const urn_exc = uranio_utils_1.urn_exception.init(`API_ROUTE_SERVER`, `Api route server module`);
...
function return_default_routes(atom_name) {
    let default_routes = uranio_utils_1.urn_util.json.clean_parse(uranio_utils_1.urn_util.json.safe_stringify(client_1.default_routes));
    if (atom_name === '_media') {
        default_routes = (0, client_1.add_media_routes)();
        default_routes.upload.call =
            async (api_request) => {
                uranio_utils_1.urn_log.trace(`Router Call POST [upload] / [${atom_name}]`);
                if (!api_request.file) {
        ...
        default_routes.presigned.call =
            async (api_request) => {
                uranio_utils_1.urn_log.trace(`Router Call GET [presigned] / [${atom_name}]`);
    ...
    default_routes.count.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [count] / [${atom_name}]`);
    ...
    default_routes.find_one.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [find_one] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            const filter = api_request.query.filter || {};
    ...
    default_routes.find.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [find] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            const filter = api_request.query.filter || {};
            const options = api_request.query.options;
    ...
    default_routes.find_id.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [find_id] /:id [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
    ...
    default_routes.insert.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call POST [insert] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            if (!api_request.body) {
    ...
    default_routes.update.call =
        async (api_request) => {
            var _a;
            uranio_utils_1.urn_log.trace(`Router Call POST [update] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            if (!api_request.body) {
    ...
    default_routes.delete.call =
        async (api_request) => {
            var _a;
            uranio_utils_1.urn_log.trace(`Router Call DELETE [delete] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
    ...
    default_routes.insert_multiple.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call POST [insert_multiple] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
    ...
    default_routes.update_multiple.call =
        async (api_request) => {
            var _a, _b, _c;
            uranio_utils_1.urn_log.trace(`Router Call POST [update_multiple] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            if (!api_request.body) {
    ...
    default_routes.delete_multiple.call =
        async (api_request) => {
            var _a, _b;
            uranio_utils_1.urn_log.trace(`Router Call DELETE [delete_multiple] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            if (!((_a = api_request.params) === null || _a === void 0 ? void 0 : _a.ids)) {
    ...
    default_routes.search.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [search] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
    ...
    default_routes.search_count.call =
        async (api_request) => {
            uranio_utils_1.urn_log.trace(`Router Call GET [search_count] / [${atom_name}]`);
            const urn_bll = uranio_core_1.default.bll.create(atom_name, api_request.passport);
            const q = api_request.params.q;
