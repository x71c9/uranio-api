...
function route(route_def, atom_name, route_name) {
    ...
    book.add_route_definition(final_atom_name, final_route_name, route_def);
    urn_lib_1.urn_log.debug(`Route [${final_route_name}] for atom [${final_atom_name}] registered.`);
